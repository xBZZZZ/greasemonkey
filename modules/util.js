...
/*
This "util" module separates all the methods into individual files,
and lazily imports them automatically, the first time each method is called.
Simply import this top-level module:
...
In the future that method will exist directly.
Thus all modules inside "util/" should define and export exactly one function,
with the same name as the file.
All other contents are privates to that method's module.
*/
var GM_util = {};
